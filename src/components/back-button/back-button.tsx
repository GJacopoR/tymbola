...
function BackButton () {
    return <Button className={classes.backButton} children={
        <Link className={classes.backLink} to='/'>
            <svg className={classes.backIcon} fill="#ff0000" height="111px" width="111px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="-35.06 -35.06 289.27 289.27" xmlSpace="preserve" stroke="#ff0000" stroke-width="12.491606999999998" transform="rotate(0)">
