...
function PlayerCard ({boxes, history}:PlayerCardProps) {
        ...
        <main className={classes.cardsContainer}>
            <section className={classes.card}>
                {boxes.map((box) => <label
                    ...
                    key={box + '_box'}>
                    <span
                        className={`${classes.boxLabel} ${history.some((tombolaNumber) => tombolaNumber.number === box) && classes.boxLabelChecked}`}>
                            <p>{box}</p>
