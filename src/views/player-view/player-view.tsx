  ...
  return (
    <PageTransition isDirectionBack={true}>
      <section className={classes.viewContainer}>
        <BackButton className={classes.backButton} size={isDesktopMode ? "large" : "small"} />
        <Button
        ...
        <main className={classes.bodyContainer}>
          {isTombola && <Fireworks options={fireworksOptions} className={classes.fireworks} />}

          <section
            className={`${classes.cardsContainer} ${
              cardsStructure.length === 1 && classes.singleCardContainer
            }`}
          >
          ...
          <Button
            ...
            children={
              ...
              >
                ...
                <g id="SVGRepo_iconCarrier">
                  <path
                    style={history.length ? { fill: "#ff0000" } : { fill: "#f08080" }}
